...
export default function CardDetailPage({
  ...
  if (loading) {
    return <div className="text-center py-12 text-muted-foreground">{t.card.loading}</div>
  }
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Badge className={cn(TYPE_COLORS[card.type])}>
      ...
      {card.ocrText && (
        <>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm bg-muted p-3 rounded-md max-h-32 overflow-y-auto whitespace-pre-wrap">
              {card.ocrText}
            </p>
          </div>
        </>
      ...
      {card.note && (
        <>
          <Separator />
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-muted-foreground">{t.card.note}</h3>
